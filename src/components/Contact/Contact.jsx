    ...
    <motion.div ref={ref} className='contact' variants={contactVariants} initial="initial" whileInView="animate" >
        ...
        <motion.div className="textContainer" variants={contactVariants}>
            ...
            <motion.div className="conItem" variants={contactVariants}>
                ...
                <div className="social-links">
                  <a href="mailto:harishmaramesh.u@gmail.com" target='_blank'>
                      ...
                      <span>harishmaramesh.u@gmail.com</span>
                  </a>
                </div>
            </motion.div>
            <motion.div className="conItem" variants={contactVariants}>
                <h2>Phone</h2>
                <div className="social-links">
                  <a href="tel:+918056834917" target='_blank'>
                      <img src="/phone.png" className='phone' alt="" />
                      <span>+91 8056834917</span>
                  </a>
                </div>
            </motion.div>
            <motion.div className="conItem" variants={contactVariants}>
                <h2>Address</h2>
                <div className="social-links">
                  <a href="https://maps.app.goo.gl/9QWCjj5PmbjZE4Jo8?g_st=aw" target='_blank'>
            ...
            <motion.div className="conItem" variants={contactVariants}>
              <h2>Social Links</h2>
              <div className="social-links">
                <a href="https://www.linkedin.com/in/harishma-r-u86b933292" target='_blank'>
